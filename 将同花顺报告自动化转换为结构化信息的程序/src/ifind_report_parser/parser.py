...
from .table_parser import extract_patents_by_cells
...
def parse_pdf(path: Path) -> ParsedReport:
    ...
    return ParsedReport(
        ...
        sections=sections,
        profile=profile,
        shareholders=parse_shareholders(get_section_text_by_prefix(sections, "1.2")),
        ...
        financing_events=parse_financing(get_section_text_by_prefix(sections, "5.6")),
        tenders=parse_tenders(get_section_text_by_prefix(sections, "4.1"), "招标公告") + parse_tenders(get_section_text_by_prefix(sections, "4.2"), "中标公告"),
        customers=parse_customers(get_section_text_by_prefix(sections, "4.3")),
        suppliers=parse_suppliers(get_section_text_by_prefix(sections, "4.4")),
        news_events=parse_news(get_section_text_by_prefix(sections, "6.5")),
